                  ...
                  <div className={`space-y-3 rounded-[24px] border px-4 py-3 text-sm ${
                    ...
                    {aiErrorLog ? (
                      <button
                        ...
                        className={`inline-flex items-center gap-2 rounded-2xl border px-3 py-2 text-xs font-bold transition active:scale-[0.98] ${
                          isDarkMode
            ...
            <div className={`border-t px-4 pb-[calc(0.9rem+env(safe-area-inset-bottom))] pt-3 sm:px-6 sm:pb-4 ${
              ...
              <div className="flex flex-col-reverse gap-2.5 sm:flex-row sm:items-center sm:justify-between">
                <button
                  ...
                  className={`rounded-2xl px-4 py-2.5 text-sm font-bold transition active:scale-[0.98] ${
                    isDarkMode
                ...
                <button
                  ...
                  disabled={!canSubmit}
                  className={`inline-flex items-center justify-center gap-2 rounded-2xl px-5 py-2.5 text-sm font-black text-white bg-gradient-to-r ${accentClasses.bgGradient} disabled:cursor-not-allowed disabled:opacity-50 active:scale-[0.98]`}
                >
