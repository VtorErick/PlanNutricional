const EMOJI_RULES: Array<{ regex: RegExp; emoji: string }> = [
  ...
  { regex: /(naranja|mandarina|toronja|pomelo)/, emoji: '🍊' },
  { regex: /(limon)/, emoji: '🍋' },
  { regex: /(fruta|manzana|pera|platano|banana|fresa|berries|frutos rojos|papaya|mango|melon|sandia|uva|kiwi|durazno)/, emoji: '🍎' },
