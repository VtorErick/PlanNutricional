...
const LANDING_THEMES: Record<ThemeKey, LandingTheme> = {
  el: {
    ...
    cardGradient: 'from-[#294d9b] via-[#315fc3] to-[#6284d7]',
    ...
    combinedBannerSubtext: 'block text-xs font-medium text-ocean-600 dark:text-ocean-300 mt-1',
    combinedStatsLabel: 'text-xs text-ocean-50/75 font-bold uppercase tracking-widest mb-1',
    combinedStatsSubtext: 'text-xs text-ocean-50/60 mt-0.5',
  },
  ella: {
    ...
    cardGradient: 'from-[#913454] via-[#b33f68] to-[#d86588]',
    ...
    combinedBannerSubtext: 'block text-xs font-medium text-coral-600 dark:text-coral-300 mt-1',
    combinedStatsLabel: 'text-xs text-coral-50/75 font-bold uppercase tracking-widest mb-1',
    combinedStatsSubtext: 'text-xs text-coral-50/60 mt-0.5',
  },
  ambos: {
    ...
    cardGradient: 'from-[#a93612] via-[#c84516] to-[#dd7447]',
    ...
    combinedBannerSubtext: 'block text-xs font-medium text-pine-700 dark:text-pine-300 mt-1',
    combinedStatsLabel: 'text-xs text-pine-50/75 font-bold uppercase tracking-widest mb-1',
    combinedStatsSubtext: 'text-xs text-pine-50/60 mt-0.5',
  },
  default: {
    ...
    combinedBannerSubtext: 'block text-xs font-medium text-ink-500 dark:text-ink-300 mt-1',
    combinedStatsLabel: 'text-xs text-cream-50/75 font-bold uppercase tracking-widest mb-1',
    combinedStatsSubtext: 'text-xs text-cream-50/60 mt-0.5',
  },
};
