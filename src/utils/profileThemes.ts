...
const LIGHT_ACCENT_COLORS: Record<ThemeKey, AccentColors> = {
  ambos: {
    ...
    btnActive: 'bg-gradient-to-r from-indigo-500 to-violet-600 text-white shadow-lg shadow-violet-500/25',
    btnInactive: 'bg-white text-slate-600 hover:bg-slate-50 border border-slate-200',
    dot: 'bg-violet-500',
    cardDone: 'bg-gradient-to-br from-indigo-500 to-violet-600 border-violet-400 shadow-violet-200',
...
const DARK_ACCENT_COLORS: Record<ThemeKey, AccentColors> = {
  ambos: {
    ...
    btnActive: 'bg-gradient-to-r from-indigo-500 to-violet-500 text-white shadow-lg shadow-violet-950/35',
    btnInactive: 'bg-slate-950/90 text-slate-200 hover:bg-slate-900 border border-violet-900/40',
    dot: 'bg-violet-400',
    cardDone: 'bg-gradient-to-br from-indigo-500 to-violet-600 border-violet-400 shadow-[0_16px_32px_rgba(91,33,182,0.28)]',
...
const DARK_MONITORING: Record<ThemeKey, MonitoringPalette> = {
  ambos: {
    hero: 'from-indigo-900 via-violet-900 to-fuchsia-950',
...
const LANDING_THEMES: Record<ThemeKey, LandingTheme> = {
  el: {
    buttonTone: 'border-blue-200/20 bg-white/10 hover:bg-white/16 shadow-[0_8px_24px_rgba(29,78,216,0.22)] hover:shadow-[0_12px_30px_rgba(29,78,216,0.32)]',
    cardGradient: 'from-[#2563eb] via-[#1d4ed8] to-[#172554]',
    cardHoverShadow: 'hover:shadow-[0_22px_60px_rgba(37,99,235,0.28)]',
    metaText: 'text-blue-50/85',
    readyDot: 'bg-sky-300 shadow-[0_0_10px_rgba(125,211,252,0.7)]',
  ...
  ella: {
    buttonTone: 'border-rose-200/20 bg-white/10 hover:bg-white/16 shadow-[0_8px_24px_rgba(190,24,93,0.22)] hover:shadow-[0_12px_30px_rgba(190,24,93,0.32)]',
    cardGradient: 'from-[#ec4899] via-[#db2777] to-[#831843]',
    cardHoverShadow: 'hover:shadow-[0_22px_60px_rgba(236,72,153,0.28)]',
    metaText: 'text-rose-50/85',
    readyDot: 'bg-pink-300 shadow-[0_0_10px_rgba(249,168,212,0.7)]',
  ...
  ambos: {
    buttonTone: 'border-violet-200/20 bg-white/10 hover:bg-white/16 shadow-[0_8px_24px_rgba(109,40,217,0.2)] hover:shadow-[0_12px_30px_rgba(109,40,217,0.3)]',
    cardGradient: 'from-[#6366f1] via-[#7c3aed] to-[#6d28d9]',
    cardHoverShadow: 'hover:shadow-[0_22px_60px_rgba(109,40,217,0.24)]',
    metaText: 'text-violet-50/85',
    readyDot: 'bg-violet-300 shadow-[0_0_10px_rgba(196,181,253,0.7)]',
